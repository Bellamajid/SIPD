...
namespace App\Filament\Officer\Resources\ExpectantMotherResource\Tables;
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\EditAction::make()
                    ...
                    ->color('success')
                    ->icon('tabler-edit')
                    ->url(fn ($record) => ExpectantMotherResource::getUrl('activities.edit', ['record' => $this->expectantMother, 'id' => $record->id])),
