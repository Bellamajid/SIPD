...
>
    <a
        ...
        @class([
            ...
            'hover:bg-gray-100 hover:text-primary-600 focus-visible:bg-gray-100 dark:hover:bg-white/5 dark:focus-visible:bg-white/5' => filled($url),
            'bg-primary-600 text-white hover:text-primary-600 dark:bg-white/5' => $active,
        ])
    >
