...
@php
    ...
    $buttonClasses = \Illuminate\Support\Arr::toCssClasses([
        ...[
            ...
            'rounded' => ! $grouped,
            'flex-1 [&:nth-child(1_of_.fi-btn)]:rounded [&:nth-last-child(1_of_.fi-btn)]:rounded [&:not(:nth-child(1_of_.fi-btn))]:shadow-[-1px_0_0_0_theme(colors.gray.200)] [&:not(:nth-last-child(1_of_.fi-btn))]:me-px dark:[&:not(:nth-child(1_of_.fi-btn))]:shadow-[-1px_0_0_0_theme(colors.white/20%)]' => $grouped,
